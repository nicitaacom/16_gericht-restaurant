...
<img className="bg-png w-full h-full" src='/pages/bg-secondary.avif'/>
<img className="g-png" src="/pages/home/G.png"/>
...
<img className='knife-png' src="./pages/home/knife.png" alt="knife.png" />
